...
Assets::principal('Lista de Problematica');
Assets::datatables();
Assets::sweetalert();
Html::header();
...
?>	
	...
	<?php 
	include'../modal/problematica/agregar.php';
	include'../modal/problematica/eliminar.php';
	?>
	<div class="row">
		<div class="col-md-12">
...
<div class="container">
	...
	<script src="../ajax/problematica.js"></script>
	<script>loadTable();</script>
	<?php Html::footer('Peru'); ?>
