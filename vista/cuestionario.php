...
<div class="container">
  ...
  <form class="navbar-form navbar-left" action="reportes/importar_cuestionario.php" >       
    <button  class="btn btn-info">Exportar reporte resumido a Excel</button>
  </form>

  <form class="navbar-form navbar-left" action="reportes/importar_cuestionario2.php" >       
    <button  class="btn btn-info">Exportar reporte a Excel</button>
  </form>
