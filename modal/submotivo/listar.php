...
include '../../autoload.php';
 ...
 ?>
 <?php if (count(Submotivo::lista())>0): ?>
  <div class="panel panel-default">
    <div class="panel-heading">
      <!-- h3.panel-title{} -->
      <h3 class="panel-title">Lista de Submotivos</h3>
    </div>
    <div class="panel-body">
      <div class="table-responsive">
        <table id="consulta" class="table table-condensed">
          ...
          <tbody>
           <?php foreach (Submotivo::lista() as $key => $value): ?>
            <tr>
              <td><?php echo $value['id']; ?></td>
              <td><?php echo $value['submotivo']; ?></td>
  ...
  <script>
    $(".btn-edit").click(function(){
      id = $(this).data("id");
      $.get("../modal/submotivo/actualizar.php","id="+id,function(data){
