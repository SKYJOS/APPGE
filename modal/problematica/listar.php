...
//$usuario = new Usuario();
 ...
 ?>
 <?php if (count(Problematica::lista())>0): ?>
  <div class="panel panel-default">
    <div class="panel-heading">
      <!-- h3.panel-title{} -->
      <h3 class="panel-title">Lista de Problemáticas</h3>
    </div>
    <div class="panel-body">
      <div class="table-responsive">
        <table id="consulta" class="table table-condensed">
          ...
          <tbody>
           <?php foreach (Problematica::lista() as $key => $value): ?>
            <tr>
  ...
  <script>
    $(".btn-edit").click(function(){
      id = $(this).data("id");
      $.get("../modal/problematica/actualizar.php","id="+id,function(data){
