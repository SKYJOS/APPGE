 ...
 <?php if (count(Prestamo::lista())>0): ?>
    ...
    <div class="panel-body">
      <div class="table-responsive">
        <table id="consulta" class="table table-condensed">
          ...
          <tbody>
           <?php foreach (Prestamo::lista() as $key => $value): ?>
            <tr>
              <td><?php echo $value['id']; ?></td>
              <td><?php echo $value['num_caso']; ?></td>
  ...
  <script>
    $(".btn-edit").click(function(){
      id = $(this).data("id");
      $.get("../modal/prestamo/actualizar.php","id="+id,function(data){
